...
<body>
    ...
    $examenfinal=$_GET["Examen_Final"];
    $trabajofinal=$_GET["Trabajo_Final"];
    $nombre=$_GET["Nombre"];
    $promedio_parcial = ($parcial1+$parcial2+$parcial3) / 3;
    $porcentaje_parcial =  $promedio_parcial * 0.55;
    $porcentaje_examenfinal =  $examen_final * 0.30;
    $porcentaje_trabajofinal =  $trabajo_final * 0.15;
    $nota_final = $porcentaje_parcial + $porcentaje_examenfinal + $porcentaje_trabajofinal;
    ...
    <table class="table table-dark table-striped table-hover table-bordered table-sm table-responsive-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php
                echo "". number_format($porcentaje_examenfinal,2);?></td>
            </tr>
            <tr>
                <th scope="row">Trabajo_Final</th>
                <td><?php
                echo "". number_format($porcentaje_trabajofinal,2);?></td>
            </tr>
            <tr>
